...
function DashboardLayoutMentor() {
    ...
    <div className=''>
      ...
      <aside className="w-24 bg-gray-100">
        ...
        <nav className="mt-5">
            ...
            <span className='text-xs font-poppins'>Dashboard</span>
            </Link>
            </div>
            <div className='flex items-center justify-center'>
            <Link
            ...
            <span className='text-xs font-poppins'>Mentees</span>
            </Link>
            </div>
            <div className='flex items-center justify-center'>
            <Link
            ...
            <span className='text-xs font-poppins'>Sessions</span>
            </Link>
            </div>
            <div className='flex items-center justify-center'>
            <Link
...
export default DashboardLayoutMentor